...
CONF_OFFSET_SETTLE_SECONDS = "offset_settle_seconds"
CONF_OFFSET_MIN_CHANGE = "offset_min_change"
CONF_OFFSET_MIN_INTERVAL_SECONDS = "offset_min_interval_seconds"
CONF_LEADER_SWITCH_THRESHOLD = "leader_switch_threshold"
CONF_LEADER_STICK_SECONDS = "leader_stick_seconds"
...
# Offset Mode stabilization defaults
DEFAULT_OFFSET_SETTLE_SECONDS = 3
DEFAULT_OFFSET_MIN_CHANGE = 0.2
DEFAULT_OFFSET_MIN_INTERVAL_SECONDS = 10
DEFAULT_LEADER_SWITCH_THRESHOLD = 0.3
DEFAULT_LEADER_STICK_SECONDS = 30
